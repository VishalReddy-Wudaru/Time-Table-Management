 ...
 */
public class StudentScheduleC implements Initializable {
            ...
            try {
                ...
                while (rs1.next()) {
                    ...
                    a[i][j]=a[i][j]+c;*/
                        ...
                        String sql = "SELECT * FROM dtt WHERE day='" + s1 + "' AND period='" + s2 + "' AND section='" + s + "'  ORDER BY id;";
                        ResultSet rs = stmt.executeQuery(sql);
                        rs.last();
                        c = rs.getRow();
                        if (c > 0) {
                            ...
                            switch (j) {
                                case 1:
                                    d.setC1(rs.getString("subject") + "\n" + rs.getString("room"));
                                    break;
                                case 2:
                                    d.setC2(rs.getString("subject") + "\n" + rs.getString("room"));
                                    break;
                                case 3:
                                    d.setC3(rs.getString("subject") + "\n" + rs.getString("room"));
                                    break;
                                case 4:
                                    d.setC4(rs.getString("subject") + "\n" + rs.getString("room"));
                                    break;
                                case 5:
                                    d.setC5(rs.getString("subject") + "\n" + rs.getString("room"));
                                    break;
                                case 6:
                                    d.setC6(rs.getString("subject") + "\n" + rs.getString("room"));
                                    break;
                                case 7:
                                    d.setC7(rs.getString("subject") + "\n" + rs.getString("room"));
                                    break;
                                case 8:
                                    d.setC8(rs.getString("subject") + "\n" + rs.getString("room"));
                                    break;
                                case 9:
                                    d.setC9(rs.getString("subject") + "\n" + rs.getString("room"));
                                    break;
