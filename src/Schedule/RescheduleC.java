...
public class RescheduleC implements Initializable{
    ...
    public void dttClick()throws IOException
    {
        Data2 d2= Table.getSelectionModel().getSelectedItem();
        String day=d2.getDay();
        String period=d2.getPeriod();
        Data3 d3= Table1.getSelectionModel().getSelectedItem();
        String room=d3.getRoom();
        updateData("dtt",day,period,room,choiceSection.getValue(),choiceFaculty.getValue(),choiceSubject.getValue());

        Stage stage;
        Parent root;
        stage=(Stage) dtt.getScene().getWindow();
    ...
    public void pttClick()throws IOException
    {
        Data2 d2= Table.getSelectionModel().getSelectedItem();
        String day=d2.getDay();
        String period=d2.getPeriod();
        Data3 d3= Table1.getSelectionModel().getSelectedItem();
        String room=d3.getRoom();
        updateData("ptt",day,period,room,choiceSection.getValue(),choiceFaculty.getValue(),choiceSubject.getValue());
        updateData("dtt",day,period,room,choiceSection.getValue(),choiceFaculty.getValue(),choiceSubject.getValue());

        Stage stage;
        Parent root;
        stage=(Stage) ptt.getScene().getWindow();
    ...
    public void updateData(String db,String sDay,String sPeriod,String sRoom,String sSec,String sFac,String sSub)
    {
        ...
        try{
            ...
            String sql = "UPDATE "+db +" "+
                    "SET section ='"+sSec+"', faculty ='"+sFac+"', subject='"+sSub+"' "+
                    "WHERE day='"+sDay+"'  AND period='"+sPeriod+"' AND room='"+sRoom+"';";
