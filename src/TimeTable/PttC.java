 ...
 */
public class PttC implements Initializable {
    ...
    public void pttEditClick()
    {
        TimeTables d=pttTable.getSelectionModel().getSelectedItem();
    ...
    public void pttRefreshClick()
    {
        refreshTable();
    }

    public void pttBackClick()throws IOException
    {
        Stage stage;
        Parent root;
        stage=(Stage) pttBack.getScene().getWindow();
    ...
    public void refreshTable()
    {
        ...
        try{
            ...
            String sql = "SELECT * FROM ptt ORDER BY id";
    ...
    public void removeExtraChoices(String day,String period)
    {
        ...
        try{
            ...
            String sql = "SELECT section,faculty,subject FROM ptt WHERE day = '"+day+"' AND period = '"+period+"' ORDER BY id;";
            rs = stmt.executeQuery(sql);
            //STEP 5: Extract data from result set
            while(rs.next())
            {
